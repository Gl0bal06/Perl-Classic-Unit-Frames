...
-- Power Types
PERL_SPELL_POWER_MANA = 0;
PERL_SPELL_POWER_RAGE = 1;
PERL_SPELL_POWER_FOCUS = 2;
PERL_SPELL_POWER_ENERGY = 3;
PERL_SPELL_POWER_COMBO_POINTS = 4;
PERL_SPELL_POWER_RUNES = 5;
PERL_SPELL_POWER_RUNIC_POWER = 6;
PERL_SPELL_POWER_SOUL_SHARDS = 7;
PERL_SPELL_POWER_LUNAR_POWER = 8;
PERL_SPELL_POWER_HOLY_POWER = 9;
PERL_SPELL_POWER_ALTERNATE_POWER = 10;
PERL_SPELL_POWER_MAELSTROM = 11;
PERL_SPELL_POWER_CHI = 12;
PERL_SPELL_POWER_INSANITY = 13;
PERL_SPELL_POWER_OBSOLETE = 14;
PERL_SPELL_POWER_OBSOLETE2 = 15;
PERL_SPELL_POWER_ARCANE_CHARGES = 16;
PERL_SPELL_POWER_FURY = 17;
PERL_SPELL_POWER_PAIN = 18;
