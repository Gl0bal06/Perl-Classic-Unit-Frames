...
function Perl_Config_Player_Set_Values()
	...
	if (vartable["paladinpowerbar"] == 1) then
		Perl_Config_Player_Frame_CheckButton31:SetChecked(1);
	else
		Perl_Config_Player_Frame_CheckButton31:SetChecked(nil);
	end

	if (vartable["shardbarframe"] == 1) then
		Perl_Config_Player_Frame_CheckButton32:SetChecked(1);
	else
		Perl_Config_Player_Frame_CheckButton32:SetChecked(nil);
	end

	if (vartable["eclipsebarframe"] == 1) then
		Perl_Config_Player_Frame_CheckButton33:SetChecked(1);
	else
		Perl_Config_Player_Frame_CheckButton33:SetChecked(nil);
	end

	if (vartable["harmonybarframe"] == 1) then
		Perl_Config_Player_Frame_CheckButton34:SetChecked(1);
	else
		Perl_Config_Player_Frame_CheckButton34:SetChecked(nil);
	end

	if (vartable["priestbarframe"] == 1) then
		Perl_Config_Player_Frame_CheckButton35:SetChecked(1);
	else
		Perl_Config_Player_Frame_CheckButton35:SetChecked(nil);
	end
...
function Perl_Config_Player_Show_Paladin_Power_Bar_Update()
	if (Perl_Config_Player_Frame_CheckButton31:GetChecked() == 1) then
...
function Perl_Config_Player_Show_Shard_Bar_Frame_Update()
	if (Perl_Config_Player_Frame_CheckButton32:GetChecked() == 1) then
...
function Perl_Config_Player_Show_Eclipse_Bar_Frame_Update()
	if (Perl_Config_Player_Frame_CheckButton33:GetChecked() == 1) then
...
function Perl_Config_Player_Show_Harmony_Bar_Frame_Update()
	if (Perl_Config_Player_Frame_CheckButton34:GetChecked() == 1) then
...
function Perl_Config_Player_Show_Priest_Bar_Frame_Update()
	if (Perl_Config_Player_Frame_CheckButton35:GetChecked() == 1) then
