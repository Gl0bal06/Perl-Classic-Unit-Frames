...
function Perl_Config_Focus_Set_Values()
	...
	if (vartable["showpvprank"] == 1) then
		Perl_Config_Focus_Frame_CheckButton2:SetChecked(1);
	else
		Perl_Config_Focus_Frame_CheckButton2:SetChecked(nil);
	end
...
function Perl_Config_Focus_PvP_Rank_Icon_Update()
	if (Perl_Config_Focus_Frame_CheckButton2:GetChecked() == 1) then
		Perl_Focus_Set_PvP_Rank_Icon(1);
	else
		Perl_Focus_Set_PvP_Rank_Icon(0);
	end
end
