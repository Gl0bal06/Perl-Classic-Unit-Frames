--if (GetLocale() == "enUS") then	-- Bypassing this allows us to at least give other languages English since they aren't fully translated
	...
	PERL_LOCALIZED_CONFIG_PLAYER_PALADIN_POWER_BAR = "Paladin Power Bar";
	PERL_LOCALIZED_CONFIG_PLAYER_SHARD_BAR_FRAME = "Warlock Power Bar";
	PERL_LOCALIZED_CONFIG_PLAYER_ECLIPSE_BAR_FRAME = "Druid Eclipse Bar";
	PERL_LOCALIZED_CONFIG_PLAYER_HARMONY_BAR_FRAME = "Monk Harmony Bar";
	PERL_LOCALIZED_CONFIG_PLAYER_PRIEST_BAR_FRAME = "Priest Power Bar";
