--if (GetLocale() == "enUS") then	-- Bypassing this allows us to at least give other languages English since they aren't fully translated
	...
	-- Perl Config Party
	PERL_LOCALIZED_CONFIG_PARTY_SPACING = "Spacing (90 is default)";
	...
	PERL_LOCALIZED_CONFIG_PLAYER_ENERGY_TICKER = "Energy Ticker";
	...
	PERL_LOCALIZED_CONFIG_TARGET_ELITE_RARE_GRAPHIC = "Elite/Rare Graphic";
